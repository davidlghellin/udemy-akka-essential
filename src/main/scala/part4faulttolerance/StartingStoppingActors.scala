...
object StartingStoppingActors extends App {
  ...
  class Parent extends Actor with ActorLogging {
    ...
    def withChildren(children: Map[String, ActorRef]): Receive = {
      ...
      case Stop =>
        ...
        context.stop(self) // asi detengo el proppio actor
      case message =>
  ...
  //  child ! "hi kid!"
  //
  //  parent ! StopChild("child1")  // aun despues de recibir el stop, puede recibir mensajes
  ...
  class Watcher extends Actor with ActorLogging {
    ...
    override def receive: Receive = {
      case StartChild(name) =>
        ...
        context.watch(child) // cuando muere este actor, recibe una terminacion especial
      case Terminated(ref) =>
